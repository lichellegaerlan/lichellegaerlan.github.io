                ...
                <Container>
                    <Row>
                        ...
                        <Col xs={12} sm={12} md={6} lg={4} className="landing-pic-container">
                            <img src={ParkInn} className="landing-portfolio-pics" alt="parkinn-portfolio" onClick={handleOpenParkinn} />
                        ...
                        <Col xs={12} sm={12} md={6} lg={4} className="landing-pic-container">
                            <img src={Readit} className="landing-portfolio-pics" alt="readit-portfolio" onClick={handleOpenReadit} />
                        ...
                        <Col xs={12} sm={12} md={6} lg={4} className="landing-pic-container">
                            <img src={Soulmates} className="landing-portfolio-pics" alt="soulmates-portfolio" onClick={handleOpenSoulmates} />
