                    ...
                    <Row>
                        ...
                        <Col xs={12} sm={12} md={4} lg={4} className="col-styles" style={{ paddingRight: "20px"}}>
                            ...
                            <p className="about-text">
                                My passion for technology and design began when I was a kid who was just
                                creating HTML/CSS layouts on MySpace and Tumblr. <br/><br/>

                                Later on, I decided to pursue a degree in Computer Science from the University of Nevada, Las Vegas
                                ...
                                As a designer, I love the process of creating meaningful experiences for users. I enjoy empathizing with
                        ...
                        <Col xs={12} sm={12} md={4} lg={4} className="col-styles">
                            ...
                            <p className="about-text">
                                <a href="https://www.16personalities.com/intj-personality" className="about-links" target="_blank"><b>The Architect (INTJ)</b></a> — 16Personalities <br/>
                            ...
                            <p className="about-text">
                            <font color="#794f47">‣</font> To use my talent and creativity to create unique solutions <br/>
                            <font color="#794f47">‣</font> To use my passion and drive for design, code, and customer service in useful ways <br/>
                            <font color="#794f47">‣</font> To use my skills to contribute to a team, and to continually build my skills in turn
                            </p>
                            <br/>
