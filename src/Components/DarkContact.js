            ...
            <Container>
                <Row>
                    <Col xs={12} sm={12} md={12} lg={12}>
                        ...
                        <p className="contact-text-dark">
                            <a className="e1-dark" href="https://github.com/lichellegaerlan" target="_blank" rel="noopener noreferrer">Github</a> / <a className="e1-dark" href="https://www.linkedin.com/in/lichellemaegaerlan" target="_blank" rel="noopener noreferrer">LinkedIn</a> / <a className="e1-dark" href="mailto:lichellemaegaerlan@gmail.com">Mail</a>
                        </p>
                    </Col>
                </Row>
            </Container>
